...
% Controlador PI
%
function [vetorrk,vetoruk,vetoryk,T] = ControleVelocidadeV1()
...
T = 1/Fa;        % Sampling time por vezes identificado como h mas aqui e´T
...
% fazer b3=0 a3=0
%
% Coeficientes para PI - Transformacao Bilinear
a1 =  2*Ti;
a2 = -2*Ti;
a3 = 0.0;
b1 = T*Kp+2*Ti*Kp;
...
yk = sample(1);               % leitura da tensao do tacometro, velocidade angular                 
% calculo do erro e(k)
ek = rk - yk;    
% Calculo do controle
...
function StopEverything(~,~)
    ...
    save('filename4.txt','matdata','-ascii')
    % mensagem para informar que a task de controle acabou
    mensagem = 'acabou'    
